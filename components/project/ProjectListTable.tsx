...
import { MoreVertical, Archive, Trash2, GripVertical, CheckCircle, ExternalLink, Hash } from 'lucide-react';
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap text-right relative">
                  ...
                  {activeMenuId === project.id && (
                    <div 
                      className="absolute right-6 top-12 w-48 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 p-2 z-[60] animate-in zoom-in-95 duration-200"
